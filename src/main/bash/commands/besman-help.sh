...
function __bes_help_set {
    ...
    printf "%-30s %-65s %-25s\n" "BESMAN_ENV_REPO_BRANCH" "Branch of the repo from which user install env scripts" "namespace/repo_name"
    printf "%-30s %-65s %-25s\n" "BESMAN_PLAYBOOK_REPO" "Repo from which user pull playbooks" "namespace/repo_name"
    printf "%-30s %-65s %-25s\n" "BESMAN_PLAYBOOK_REPO_BRANCH" "Branch of the repo from which user pulls playbook" "namespace/repo_name"
